...
import 'package:kitchen2cabin_user_app/mainScreens/home_screen.dart';
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Align(
            ...
            child: FloatingActionButton.extended(
              heroTag: "btn1",
              label: const Text("Clear Cart", style: TextStyle(fontSize: 16,color: Colors.black),),
          ...
          Align(
            ...
            child: FloatingActionButton.extended(
              heroTag: "btn2",
              label: const Text("Check Out", style: TextStyle(fontSize: 16,color: Colors.black),),
              backgroundColor: Colors.green.shade200,
              icon: const Icon(Icons.navigate_next,color: Colors.black,),
              onPressed: ()
              {

                Navigator.push(context, MaterialPageRoute(builder: (c)=> AddressScreen(totalAmount: totalAmount.toDouble(), sellerUID: widget.sellerUID,),),);
    ...
    body: CustomScrollView(
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: Consumer<TotalAmount>(builder: (context, amountProvider, c)
          {
            return Padding(
